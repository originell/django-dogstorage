...
class ColorDog(FileSystemStorage):
    """
    If a file is not found on disk, return a dog picture.
    """
    def _open(self, name, mode='rb'):
        if not self.exists(name):
            ...
            if not dogz:
                ...
                response = urllib2.urlopen('http://placedog.com/%s/%s'
        ...
        return super(ColorDog, self)._open(name, mode)
